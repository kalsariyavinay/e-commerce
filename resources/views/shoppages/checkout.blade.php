                    ...
                    <div class="card-body p-4">
                        <div class="row d-flex justify-content-between align-items-center">
                            ...
                            <div class="col-md-3 col-lg-3 col-xl-2 d-flex">
                                ...
                                <input id="form1" min="0" max="999" name="quantity" value="1" type="number" class="form-control form-control-sm" />
                            ...
                            <div class="col-md-1 col-lg-1 col-xl-1 text-end"><a href="" class="btn btn-danger"><i class="fa-sharp fa-solid fa-trash"></i></a></div>
